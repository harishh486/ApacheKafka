...
public class SensorConsumer{
    ...
    public static void main(String[] args) throws Exception{
            ...
            consumer = new KafkaConsumer<>(props);// making control of consumers to assign the partitioners ,not kafka is allocating the partitioners to consumer
    ...
    private static long getOffsetFromDB(TopicPartition p){
        ...
        try{
                ...
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/test","root","Harish");
